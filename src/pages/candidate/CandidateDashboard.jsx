...
const CandidateDashboard = () => {
  ...
  const getCompanyName = (job) => {
    ...
    if (
      typeof job?.recruiter?.name === "string"
    ) {
  ...
  const getApplicationCompanyName = (
    ...
    if (
      typeof application?.job?.company ===
      "string"
    ) {
    ...
    if (
      typeof application?.company?.name ===
      "string"
    ) {
  ...
  const getInterviewCompanyName = (
    interview
  ) => {
    if (
      typeof interview?.application?.job
        ?.company === "string"
    ) {
    ...
    if (
      typeof interview?.job?.company?.name ===
      "string"
    ) {
    ...
    <div className="min-h-screen overflow-x-hidden bg-[#f5f8fc] text-[#152b4d]">
      ...
      <aside className="fixed left-0 top-0 z-30 hidden h-screen w-[255px] bg-[#0c1d36] text-white lg:block">
        ...
        <button
          ...
          className="absolute bottom-7 left-4 flex w-[calc(100%-32px)] items-center gap-4 rounded-lg px-4 py-3 text-sm text-slate-300 transition hover:bg-white/10 hover:text-white"
        >
          <LogOut size={20} />
          Logout
        </button>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="relative h-full w-[275px] max-w-[85vw] overflow-y-auto bg-[#0c1d36] p-5 text-white shadow-2xl">
              ...
              {sidebarItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center gap-4 rounded-lg px-4 py-3 text-left text-sm ${
                      item.active
                  ...
                  >
                    ...
                    {item.badge !== null &&
                      item.badge !== undefined && (
                        <span className="rounded-full bg-red-500 px-2 py-0.5 text-[10px]">
                          {item.badge}
                        </span>
                      )}
                  </button>
            ...
            <button
              type="button"
              onClick={handleLogout}
              className="absolute bottom-7 left-5 flex w-[calc(100%-40px)] items-center gap-4 rounded-lg px-4 py-3 text-sm text-slate-300 hover:bg-white/10"
            >
              <LogOut size={20} />
              Logout
            </button>
      ...
      <div className="min-h-screen lg:ml-[255px]">
        ...
        <header className="hidden h-[72px] items-center justify-between border-b border-slate-200 bg-white px-6 lg:flex xl:px-8">
          ...
          <div className="relative w-full max-w-[610px]">
            ...
            <input
              ...
              className="h-[45px] w-full rounded-xl border border-slate-200 bg-white pl-12 pr-5 text-sm text-slate-700 outline-none placeholder:text-slate-400 focus:border-blue-400 focus:ring-4 focus:ring-blue-100"
            />
              ...
              <section className="mt-5 grid grid-cols-1 gap-5 xl:grid-cols-[minmax(0,1.7fr)_minmax(290px,0.9fr)]">
                ...
                <div className="relative overflow-hidden rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <p className="mt-6 max-w-[220px] text-[12px] leading-6 text-slate-500">
                    Keep your profile updated and apply for jobs that match your skills.
                  </p>
