...
export default function RecruiterSettings() {
  ...
  useEffect(() => {
    ...
    const loadProfile = async () => {
      try {
        ...
        const companyLocation = getCompanyValue(
          currentUser,
          "location",
        ...
        setSettings(
          normalizeSettings(currentUser?.settings)
        );
  ...
  const saveProfileData = async (
    ...
    if (
      ...
      setSettings(
        normalizeSettings(
          updatedUser?.settings || payload.settings
        )
      );
  ...
  const handleSaveProfile = async (event) => {
    ...
    try {
      ...
      console.error(
        "Recruiter profile update error:",
        err
      );
        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-500">
              Manage your recruiter profile, company
              information, notifications and password.
            </p>
          </div>
