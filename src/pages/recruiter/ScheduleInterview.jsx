...
function ScheduleInterview() {
  ...
  // =========================================================
  // IMPORTANT: pass an OBJECT, not a bare token string.
  // Passing `token` alone caused the thunk to destructure
  // String.prototype.search into `search`, which broke the
  // query and returned 0 results.
  // =========================================================
  ...
  const handleSubmit = async (event) => {
    ...
    const interviewData = {
      ...
      location:
        formData.mode === "offline" ? location : "",
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_330px]">
          ...
          <section className="rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="p-5">
              ...
              <FieldGroup label="Application" required>
                ...
                {submitAttempted && !formData.applicationId && (
