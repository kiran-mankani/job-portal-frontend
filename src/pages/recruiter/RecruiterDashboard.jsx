...
function RecruiterDashboard() {
  ...
  const statistics =
    ...
    typeof dashboard.statistics === "object"
      ? dashboard.statistics
      : {};

  const jobCounts =
    dashboard?.jobCounts &&
    typeof dashboard.jobCounts === "object"
      ? dashboard.jobCounts
      : dashboard?.jobsCount &&
        typeof dashboard.jobsCount === "object"
      ? dashboard.jobsCount
      : {};
  ...
  const statusItems = [
    ...
    {
      label: "Interview",
      value: interviewApplicationCount,
      dot: "bg-emerald-500",
    },
    {
      label: "Shortlisted",
  ...
  return (
    <div className="min-h-screen bg-[#f5f8fc] text-[#172b4d]">
      ...
      <header className="sticky top-0 z-50 flex h-[68px] items-center justify-between border-b border-slate-200 bg-white px-4 shadow-sm lg:hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            aria-label="Recruiter profile settings"
          >
            <Avatar
              user={user}
              name={recruiterName}
      ...
      <div className="min-h-screen lg:ml-[250px]">
        ...
        <header className="hidden h-[78px] items-center justify-between border-b border-slate-200 bg-white px-6 lg:flex xl:px-8">
          ...
          <div className="relative w-full max-w-[600px]">
            ...
            <input
              ...
              className="h-12 w-full rounded-xl border border-slate-200 bg-white pl-11 pr-4 text-sm outline-none transition placeholder:text-slate-400 focus:border-blue-400 focus:ring-4 focus:ring-blue-50"
          ...
          <div className="ml-6 flex items-center gap-5">
            ...
            <button
              ...
              className="relative text-slate-500 transition hover:text-blue-600"
              aria-label="Messages"
            >
        ...
        <div className="border-b border-slate-200 bg-white px-4 py-3 lg:hidden">
          <div className="relative">
            ...
            <input
              ...
              className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50 pl-10 pr-4 text-sm outline-none focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-50"
              aria-label="Search jobs"
              maxLength={100}
            />
          </div>
        ...
        <main className="px-4 py-5 sm:px-5 lg:px-6 lg:py-7 xl:px-8">
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="text-[21px] font-bold text-[#172b4d]">
          {total}
        </span>
